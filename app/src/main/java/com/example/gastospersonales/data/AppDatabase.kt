...
@Database(entities = [User::class, Movement::class, Account::class, Category::class, Group::class, GroupMember::class, SharedExpense::class], version = 7, exportSchema = false)
